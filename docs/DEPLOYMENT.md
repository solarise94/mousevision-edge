...
- API Token：`K5GgOuwdxf2Zuxyjo5pn3ihliNhnQJLb`（写端点需 `X-MouseVision-Token` 头）
...
- 主机：`lxbio-Inspiron-16-5620`（Ubuntu 26.04, 16C/14G）
- LAN SSH：`ssh lxbio-lan`（192.168.31.61，有时不可达）
- FRP SSH：`ssh lxbio`（经 frp，稳定可达）
- sudo 密码：`lxbio2025`
